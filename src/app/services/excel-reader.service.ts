...
export class ExcelReaderService {
  ...
  private extractData(wb: XLSX.WorkBook): SheetData {
    ...
    const keys = {
      ...
      titular:             col(['titular']),
      horaInicioAtencion:  col(['hora_inicio_atencion', 'hora inicio atencion', 'inicio_atencion', 'inicio atencion']),
      horaFinAtencion:     col(['hora_fin_atencion', 'hora fin atencion', 'fin_atencion', 'fin atencion']),
